...
export default function Skills() {
    ...
    return(
        <div className="bg-[#cddfae] xl:h-[50vh] md:w-[60vw] flex flex-col justify-center items-center max-w-[1280px] w-[100%] mt-14 max-h-[40rem] 2xl:mt-0" id="skills">
            ...
            <div className="flex flex-row items-center justify-center flex-wrap md:w-[73%] w-[100%] h-[60%] max-w-[40rem] max-h-[20rem] mt-4">
                {skills.map((item)=>{
                    return(
