...
export default function PopUp({ project, onClick }: PopUpProps) {
  ...
  return (
    <div className="fixed z-10 h-full w-full top-0 left-0 flex items-center justify-center ">
        <div className="relative p-9 xl:w-[50vw] lg:w-[60vw] md:w-[70vw] sm:w-[80vw] w-[90vw]  flex flex-row justify-center items-center border-4 bg-[var(--lightGreen)] border-[var(--pandaLight)] rounded-xl">
        <a
        ...
        <img
            ...
            className=" w-[30%] object-contain rounded-xl sm:ml-5 ml-2"
        />
        <div className="w-[70%] flex flex-col justify-between items-start sm:mr-5 mr-2">
            <div className="font-extrabold text-[var(--pandaLight)] xl:text-4xl sm:text-3xl text-2xl ml-5 flex items-center justify-center">
